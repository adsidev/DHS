...
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ReportViewer1.ServerReport.ReportPath = "/" + ConfigurationManager.AppSettings["SSRSFolder"].ToString() + "/DrawsDone";
                ...
                Param[0] = new Microsoft.Reporting.WebForms.ReportParameter("ProjectId", ViewData["Project"].ToString());
                Param[1] = new Microsoft.Reporting.WebForms.ReportParameter("FiscalYearId", ViewData["FiscalYear"].ToString());
