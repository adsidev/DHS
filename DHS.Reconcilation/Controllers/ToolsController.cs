...
namespace DHS.Reconcilation.Controllers
{
    public class ToolsController : Controller
    {
        ...
        [HttpGet]
        public ActionResult ImportExpensesTransaction()
        {
            if (!Common.SessionExists())
                return RedirectToAction("Index", "Home");
            return View();
        ...
        [HttpPost]
        public async Task<ActionResult> ImportExpensesTransaction(HttpPostedFileBase fileUpload)
        {
            if (!Common.SessionExists())
                return RedirectToAction("Index", "Home");
            ...
            if (fileUpload != null)
            {
                ...
                foreach (var item in SheetName)
                {
                    ...
                    string url = strBaseURL + "Import/ImportExpensesTransaction";
                    HttpClient client = new HttpClient();
                    client.DefaultRequestHeaders.Accept.Clear();
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    client.BaseAddress = new Uri(url);
        ...
        [HttpGet]
        public ActionResult ImportExpensesTransactionPriorYear()
        {
            if (!Common.SessionExists())
                return RedirectToAction("Index", "Home");
            return View();
        ...
        [HttpPost]
        public async Task<ActionResult> ImportExpensesTransactionPriorYear(HttpPostedFileBase fileUpload)
        {
            if (!Common.SessionExists())
                return RedirectToAction("Index", "Home");
            ...
            if (fileUpload != null)
            {
                ...
                foreach (var item in SheetName)
                {
                    ...
                    string url = strBaseURL + "Import/ImportPriorYearExpenseTransaction";
                    HttpClient client = new HttpClient();
                    client.DefaultRequestHeaders.Accept.Clear();
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    client.BaseAddress = new Uri(url);
