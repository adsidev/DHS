...
namespace DHS.Reconcilation.Areas
{
    ...
    public class ExpenseController : ApiController
    {
        ...
        [HttpPost]
        [Route("GetMissingExpenses")]
        public ExpenseResponse GetMissingExpenses(ExpenseRequest expenseRequest)
        {
            try
            {
                expenseResponse = expenseRepository.GetMissingExpenses(expenseRequest);
            }
            catch (Exception ex)
            {
                expenseResponse.ErrorMessage = ex.Message;
        ...
        [HttpPost]
        [Route("GetPriorYearTransactionDetail")]
        public ExpenseResponse GetPriorYearTransactionDetail(ExpenseRequest expenseRequest)
        {
            try
            {
                expenseResponse = expenseRepository.GetPriorYearTransactionDetail(expenseRequest);
            }
            catch (Exception ex)
            {
                expenseResponse.ErrorMessage = ex.Message;
        ...
        [HttpPost]
        [Route("SavePriorYearExpenseTransaction")]
        public ExpenseResponse SavePriorYearExpenseTransaction(ExpenseRequest expenseRequest)
        {
            try
            {
                expenseResponse = expenseRepository.SavePriorYearExpenseTransaction(expenseRequest);
            }
            catch (Exception ex)
            {
                expenseResponse.ErrorMessage = ex.Message;
        ...
        [HttpPost]
        [Route("RemovePriorYearRevenueTranscation")]
        public ExpenseResponse RemovePriorYearRevenueTranscation(ExpenseRequest expenseRequest)
        {
            try
            {
                expenseResponse = expenseRepository.RemovePriorYearRevenueTranscation(expenseRequest);
            }
            catch (Exception ex)
            {
                expenseResponse.ErrorMessage = ex.Message;
