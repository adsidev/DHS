    ...
    public class DrawDAL : IDrawDALRepository
    {
        ...
        public DrawResponse GetDraws(DrawRequest drawRequest)
        {
            ...
            SqlObject.Parameters = new object[] {
                ...
                drawRequest.drawEntity.DrawAmount,
            };
        ...
        public DrawResponse GetTransactionByDrawId(DrawRequest drawRequest)
        {
            ...
            if (drawRequest.drawEntity.DrawId > 0)
            {
                ...
                var priorYearRevenueDataSet = SqlHelper.ExecuteDataset(_connectionString, StoredProcedures.Draw.USPGETPRIORYEARTRANSACTIONBYDRAWID, SqlObject.Parameters);
            ...
            drawResponse.priorYearTransactionDetailEntities = priorYearTransactionDetailEntities;
