...
namespace DHSDAL
{
    public class StoredProcedures
    {
        ...
        public class Expense
        {
            ...
            public const string USPSAVEPRIORYEAREXPENSETRANSACTION = "sp_SavePriorYearExpenseTransaction";
            ...
            public const string USPREMOVEPRIORYEARREVENUETRANSACTION = "sp_RemovePriorYearRevenueTranscation";
        }
        ...
        public class Revenue
        {
            ...
            public const string USPREPORTDIFFREVENUEEXPENSETRANSACTION = "sp_ReportDiffRevenueExpenseTransaction";
            public const string USPREPORTDIFFREVENUEEXPENSETRANSACTIONONSCREEN = "sp_ReportDiffRevenueExpenseTransactionOnScreen";
        ...
        public class Project
        {
            ...
            public const string USPGETPROJECTSTATUS = "sp_GetProjectStatus";
