    ...
    public class RevenueDAL : IRevenueDALRepository
    {
        ...
        public RevenueResponse GetRevenueTransactions(RevenueRequest revenueRequest)
        {
            ...
            foreach (DataRow revenueDataRow in transactionDetailDataSet.Tables[0].Rows)
            {
                ...
                try
                {
                    ...
                    revenueTransactionEntity.StatusId = Convert.ToInt32(revenueDataRow["StatusId"].ToString());
                    ...
                    revenueTransactionEntity.StatusName = revenueDataRow["StatusName"].ToString();
        ...
        public RevenueResponse GetRevenueTransaction(RevenueRequest revenueRequest)
        {
            ...
            else
            {
                ...
                revenueTransactionEntity.FiscalYearId = revenueEntity.FiscalYearId;
                revenueTransactionEntity.StatusId = revenueEntity.StatusId;
            }
        ...
        public RevenueResponse SaveRevenueTransaction(RevenueRequest revenueRequest)
        {
            try
            {
                ...
                revenueRequest.revenueTransactionEntity.StatusId
                };
        ...
        {
            List<TransactionDetailEntity> transactionDetailEntities = new List<TransactionDetailEntity>();
            List<TransactionDetailEntity> priorYearTransactionDetailEntities = new List<TransactionDetailEntity>();
            RevenueTransactionEntity revenueTransactionEntity = new RevenueTransactionEntity();
            ...
            var drawDataSet = SqlHelper.ExecuteDataset(_connectionString, StoredProcedures.Revenue.USPGETTRANSACTIONSBYREVENUETRANSACTIONID, SqlObject.Parameters);
            foreach (DataRow expenseDataRow in drawDataSet.Tables[0].Rows)
            {
                TransactionDetailEntity transactionDetailEntity = new TransactionDetailEntity();
                try
            ...
            //Prior Year Transactions for a particular revenue transaction
            var priorYearRevenueDataSet = SqlHelper.ExecuteDataset(_connectionString, StoredProcedures.Revenue.USPGETPRIORYEAREXPENSETRANSACTIONSBYREVENUETRANSACTIONID, SqlObject.Parameters);
            foreach (DataRow expenseDataRow in priorYearRevenueDataSet.Tables[0].Rows)
            {
                TransactionDetailEntity transactionDetailEntity = new TransactionDetailEntity();
                try
                {
                ...
                {
                    priorYearTransactionDetailEntities.Add(transactionDetailEntity);
                }
            }
